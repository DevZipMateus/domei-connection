      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <ScrollReveal direction="left">
            <div className="space-y-6">
              {[
                ...
                <div
                  key={item.label}
                  className="flex items-start gap-4 bg-background/80 backdrop-blur-sm border border-border rounded-lg p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-md font-medium text-sm hover:bg-accent hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
              >
          ...
          <ScrollReveal direction="right">
            <div className="rounded-lg overflow-hidden border border-border h-[400px] lg:h-full shadow-md hover:shadow-xl transition-shadow duration-500">
              <iframe
